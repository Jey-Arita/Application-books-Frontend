...
export const GeneroListLibros = () => {
    ...
    const { libros, loading: loadingLibros, error: errorLibros } = useLibrosPorGenero(id);
        ...
        <div className="container mx-auto px-6 py-10">
            <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                <div className="bg-slate-200 p-6 flex items-center">
                    ...
                    <h1 className="text-3xl font-bold text-blue-500">Lista de Libros por Género</h1>
                </div>

                <div className="p-6">
                    {loadingLibros ? (
                        <div className="flex items-center justify-center text-gray-600 space-x-2">
                            <LuLoader2 className="mr-2 animate-spin text-blue-600" size={24} />
                        ...
                        <div className="flex items-center justify-center text-red-500 space-x-2">
                            ...
                            <span className="text-lg">Error al cargar los libros: {errorLibros}</span>
                        </div>
                    ) : libros?.length > 0 ? (
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                            {libros.map(libro => (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        <h4 className="text-xl font-semibold text-gray-800 mb-2">{libro.titulo}</h4>
                                        <p className="text-gray-600 mb-4 line-clamp-3">{libro.descripcion}</p>
